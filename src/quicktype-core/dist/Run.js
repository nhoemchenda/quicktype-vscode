...
class Run {
    ...
    renderGraph(targetLanguage, graph) {
        ...
        var subTypePrefix = '';
        graph.topLevels.forEach(function (value, key) {
            subTypePrefix = key;
        });
        return targetLanguage.renderGraphAndSerialize(this._options.prependSubTypeWithRoot,
            subTypePrefix, graph, this._options.outputFilename, this._options.alphabetizeProperties, this._options.leadingComments, this._options.rendererOptions, this._options.indentation);
    }
}
/**
