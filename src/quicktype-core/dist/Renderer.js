...
class Renderer {
    constructor(targetLanguage, renderContext) {
        ...
        this.prependSubTypeWithRoot = renderContext.prependSubTypeWithRoot;
        this.subTypePrefix = renderContext.subTypePrefix;
        this._finishedFiles = new Map();
        this._finishedEmitContexts = new Map();
        this._emitContext = new EmitContext();
        this._emitContext.prependSubTypeWithRoot = this.prependSubTypeWithRoot;
        this._emitContext.subTypePrefix = this.subTypePrefix;
    }
    ...
    assignNames() {
        return Naming_1.assignNames(this.setUpNaming(), this._emitContext.prependSubTypeWithRoot, this._emitContext.subTypePrefix);
