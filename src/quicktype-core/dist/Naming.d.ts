...
export declare class Namer {
    ...
    assignNames(names: ReadonlyMap<Name, string>, forbiddenNamesIterable: Iterable<string>, namesToAssignIterable: Iterable<Name>, prependSubTypeWithRoot: boolean,
        subTypePrefix: string): ReadonlyMap<Name, string>;
}
...
export declare function assignNames(rootNamespaces: Iterable<Namespace>, prependSubTypeWithRoot: boolean, subTypePrefix: string): ReadonlyMap<Name, string>;
