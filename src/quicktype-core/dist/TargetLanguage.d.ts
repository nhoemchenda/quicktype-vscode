...
export declare abstract class TargetLanguage {
    ...
    renderGraphAndSerialize(prependSubTypeWithRoot: boolean,
        subTypePrefix: string, typeGraph: TypeGraph, givenOutputFilename: string, alphabetizeProperties: boolean, leadingComments: string[] | undefined, rendererOptions: {
            [name: string]: any;
